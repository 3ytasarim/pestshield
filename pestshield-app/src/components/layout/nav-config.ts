  ...
  CUSTOMER: [
    {
      ...
      items: [
        ...
        { label: "Takvim", href: "/dashboard/customer/calendar", icon: Calendar },
        { label: "Talepler", href: "/dashboard/customer/support", icon: LifeBuoy },
        { label: "Raporlar", href: "/dashboard/customer/reports", icon: FileBarChart },
        { label: "Firmalar ve Belgeleri", href: "/dashboard/customer/documents", icon: FolderOpen },
        { label: "Hizmetler", href: "/dashboard/customer/services", icon: ListChecks },
        { label: "Teklifler", href: "/dashboard/customer/offers", icon: FileText },
