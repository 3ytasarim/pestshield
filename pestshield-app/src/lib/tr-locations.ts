// Türkiye'nin 81 ili ve ilçeleri — Şehir seçilince İlçe listesi otomatik
// daralır (bağımlı/cascading dropdown). Alfabetik sıralıdır.
...
export const TR_PROVINCES: Record<string, string[]> = {
  ...
  Balıkesir: ["Altıeylül", "Ayvalık", "Bandırma", "Bigadiç", "Burhaniye", "Dursunbey", "Edremit", "Erdek", "Gömeç", "Gönen", "Havran", "İvrindi", "Karesi", "Kepsut", "Manyas", "Marmara", "Savaştepe", "Sındırgı", "Susurluk"],
  ...
  Denizli: ["Acıpayam", "Babadağ", "Baklan", "Bekilli", "Beyağaç", "Bozkurt", "Buldan", "Çal", "Çameli", "Çardak", "Çivril", "Merkezefendi", "Güney", "Honaz", "Kale", "Pamukkale", "Sarayköy", "Serinhisar", "Tavas"],
...
export const TR_CITY_LIST = Object.keys(TR_PROVINCES).sort((a, b) => a.localeCompare(b, "tr"));
